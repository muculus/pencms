<div id="tabpanel"> 
	<ul> 
		<li><a href="#tab1"><span><?php echo "<?php __('Add {$singularHumanName}');?>";?></span></a></li>
	</ul>
	
	<div id="tab1">
		<script type="text/javascript">
			$(document).ready(function() {
				$('#<?php echo $singularVar; ?>Form').load(<?php echo "'<?php echo \$html->url(array('controller'=>'{$controllerPath}','action'=>'form'));?>','#{$singularVar}Form'"; ?>);
			});
		</script>
