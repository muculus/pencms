...
<th class="id"><?php echo $paginator->sort('id');?></th><th class="title"><?php echo $paginator->sort('title');?></th><th class="widget_id"><?php echo $paginator->sort('widget_id');?></th><th class="publish"><?php echo $paginator->sort('publish');?></th><th class="created"><?php echo $paginator->sort('created');?></th><th class="end_date"><?php echo $paginator->sort('end_date');?></th>	<th class="actions"><?php __('Actions');?></th>
</tr>
<?php
$i = 0;
...
?>
	<tr<?php echo $class;?>>
		...
		<td class="category_id">
			<?php echo $message['Message']['widget_id']; ?>
		</td>
		<td class="publish">
