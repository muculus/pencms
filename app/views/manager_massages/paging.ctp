...
<th class="id"><?php echo $paginator->sort('id');?></th><th class="manager_id"><?php echo $paginator->sort('manager_id');?></th><th class="created"><?php echo $paginator->sort('created');?></th><th class="publish"><?php echo $paginator->sort('publish');?></th><th class="code"><?php echo $paginator->sort('code');?></th><th class="modified"><?php echo $paginator->sort('modified');?></th><th class="created_by"><?php echo $paginator->sort('created_by');?></th><th class="modified_by"><?php echo $paginator->sort('modified_by');?></th>	<th class="actions"><?php __('Actions');?></th>
</tr>
<?php
$i = 0;
...
?>
	<tr<?php echo $class;?>>
		...
		<td class="manager_id">
			<?php echo $html->link($managerMassage['Manager']['id'], array('controller'=> 'managers', 'action'=>'view', $managerMassage['Manager']['id'])); ?>
		</td>
		<td class="created">
		...
		<td class="modified">
			<?php echo $managerMassage['ManagerMassage']['modified']; ?>
		</td>
		<td class="created_by">
			<?php echo $managerMassage['ManagerMassage']['created_by']; ?>
		</td>
		<td class="modified_by">
			<?php echo $managerMassage['ManagerMassage']['modified_by']; ?>
		</td>
		<td class="actions">
			<?php
