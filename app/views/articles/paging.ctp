...
$page=1;
 ...
 foreach($articles as $row):
	   $val = explode(" ",$row['Article']['publish_date']);
       $date = explode("-",$val[0]);
       $time = explode(":",$val[1]);
...
<div class="article_column column1" >
 ...
 <a  href="/articles/view/<?php echo $row['Article']['id']; ?>"><h2 class="contentheading"> 
 <?php echo  $row['Article']['title'] ?>
 </h2></a>

<div class="article-tools clearfix">
<div class="article-meta" >
	<span class="createby"><?php echo " نوشته شده توسط : <b >".$row['Article']['author']. "</b></span><br />   <span class='createdate'><em>".$persian_date."</em>"; ?></span>
<div class="buttonheading">
		<span><a rel="nofollow" class="addthis_button_email" ><img alt="E-mail" src="/img/emailButton.png"/></a></span>
		<span><a rel="nofollow" href="http://www.daneshfa.com/articles/printv/<?php echo $row['Article']['id']; ?>" target="_blank" title="Print" href=""><img alt="Print" src="/img/printButton.png"/></a></span>
...
<p><?php 
echo $html->image( '/imagephp/phpThumb.php?src=/app/webroot/img/widget/picture'."/".$row['Widget']['picture'].'&amp;w=100&amp;h=84&amp;far=B&amp;bg=FF0000&amp;f=png&amp;sia='.$row['Widget']['picture'] ,array( 'width'=> 100 ,'height'=> 84 ,'class' => 'caption','alt' => $row['Article']['title'],'align'=>'right'));
//echo $html->image( '/'.$row['Article']['image_dir'].'/thumb.small.'.$row['Article']['image'] ,array(  'class' => 'caption','alt' => $row['Article']['title'],'align'=>'left'));?></p><?php echo $shorten->shortenText($row['Article']['intro'], 600) ?>
    
</div>

   
								<a class="readon" href="/articles/view/<?php echo $row['Article']['id']; ?>"><span>بیشتر...</span></a>
<!-- share button -->
<div align="left" class="pagingShareButton" >
 
 
	<button type="button" class="share_button_share" onclick=";return false;" id="<?php echo "shareID".$row['Article']['id']; ?>">
	<span>Share</span></button>
 
	<br clear="all" />
 
	<div class="load_buttons_box_share"  id="<?php echo "shareID".$row['Article']['id']."Box"; ?>">
