...
<div class="article_column column1" >
 ...
 <a  href="/articles/view/<?php echo $row['id']; ?>"><h2 class="contentheading"> 
 <?php echo  $row['title'] ?>
 </h2></a>

<div class="article-tools clearfix">
<div class="article-meta" >
	<span class="createby"><?php echo " نوشته شده توسط : <b >".$row['author']. "</b></span><br />   <span class='createdate'><em>".$persian_date."</em>"; ?></span>
<div class="buttonheading">
		<span><a rel="nofollow" class="addthis_button_email" ><img alt="E-mail" src="/img/emailButton.png"/></a></span>
		<span><a rel="nofollow" href="http://www.daneshfa.com/articles/printv/<?php echo $row['id']; ?>" target="_blank" title="Print" href=""><img alt="Print" src="/img/printButton.png"/></a></span>
...
<p><?php 
echo $html->image( '/imagephp/phpThumb.php?src=/app/webroot/img/category/picture'."/".$row['picture'].'&amp;w=100&amp;h=84&amp;far=B&amp;bg=FF0000&amp;f=png&amp;sia='.$row['picture'] ,array( 'width'=> 100 ,'height'=> 84 ,'class' => 'caption','alt' => $row['title'],'align'=>'right'));
//echo $html->image( '/'.$row['image_dir'].'/thumb.small.'.$row['image'] ,array(  'class' => 'caption','alt' => $row['title'],'align'=>'left'));?></p><?php echo $shorten->shortenText($row['intro'], 600) ?>
    
</div>

   
								<a class="readon" href="/articles/view/<?php echo $row['id']; ?>"><span>بيشتر...</span></a>
<!-- share button -->
