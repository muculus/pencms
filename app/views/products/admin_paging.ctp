...
<th class="id"><?php echo $paginator->sort('id');?></th><th class="widget_id"><?php echo $paginator->sort('widget_id');?></th><th class="title"><?php echo $paginator->sort('title');?></th><th class="price"><?php echo $paginator->sort('price');?></th><th class="description"><?php echo $paginator->sort('description');?></th><th class="picture"><?php echo $paginator->sort('picture');?></th><th class="picture_dir"><?php echo $paginator->sort('picture_dir');?></th><th class="picture_mimetype"><?php echo $paginator->sort('picture_mimetype');?></th>	<th class="actions"><?php __('Actions');?></th>
</tr>
<?php
$i = 0;
