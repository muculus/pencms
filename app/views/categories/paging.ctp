...
<th class="id"><?php echo $paginator->sort('id');?></th><th class="parent_id"><?php echo $paginator->sort('parent_id');?></th><th class="content_id"><?php echo $paginator->sort('content_id');?></th><th class="site_layout_id"><?php echo $paginator->sort('site_layout_id');?></th><th class="lft"><?php echo $paginator->sort('lft');?></th><th class="rght"><?php echo $paginator->sort('rght');?></th><th class="title"><?php echo $paginator->sort('title');?></th><th class="access"><?php echo $paginator->sort('access');?></th><th class="publish"><?php echo $paginator->sort('publish');?></th>	<th class="actions"><?php __('Actions');?></th>
</tr>
<?php
$i = 0;
