...
class AclAppController extends AppController
{
	...
	private function _check_config()
	{
		...
		if(!empty($role_model_name))
		{
	    	...
	    	$this->set('role_fk_name',       Inflector :: underscore(Configure :: read('acl.aro.role.model')) . '_id');
	...
	private function _authorize_admins()
	{
		...
		$model_role_fk = Inflector::underscore(Configure :: read('acl.aro.role.model')) . '_id';
