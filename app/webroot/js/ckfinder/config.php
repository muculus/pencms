...
{    
	...
	return (!empty($_SESSION['Auth']) && !empty($_SESSION['Auth']['User']));
}
...
*/
$fullpath = str_replace('\\', '/', dirname(dirname(dirname(__FILE__))) . '/files/');
...
$baseUrl = substr($fullpath, $docrootlen);
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => 0,
		'allowedExtensions' => '7z,aiff,asf,avi,bmp,csv,docx,fla,flv,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pxd,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,sitd,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,xls,zip',
		'deniedExtensions' => '');
