...
FCKConfig.ToolbarSets["Default"] = [
	...
	['TextColor','BGColor'],
	['FitWindow','ShowBlocks','-','About','-','insertHtml']		// No comma for the last row.
] ;

FCKConfig.ToolbarSets["Basic"] = [
	['Bold','Italic','Underline','TextColor','-','OrderedList','UnorderedList','-'],
	['Cut','Copy','Paste','PasteText','PasteWord','-','Print','SpellCheck'],
...
FCKConfig.LinkUploadAllowedExtensions	= ".(7z|aiff|asf|avi|bmp|csv|doc|docx|fla|flv|gif|gz|gzip|jpeg|jpg|mid|mov|mp3|mp4|mpc|mpeg|mpg|ods|odt|pdf|png|ppt|pptx|pxd|qt|ram|rar|rm|rmi|rmvb|rtf|sdc|sitd|swf|sxc|sxw|tar|tgz|tif|tiff|txt|vsd|wav|wma|wmv|xls|xml|zip|docx)$" ;			// empty for all
...
FCKConfig.Plugins.Add('insertHtml', 'en,nl');
	...
	FCKConfig.insertHtml_snippet = '<div style="border-top: #999999 1px dotted;border-bottom: #999999 1px dotted;backgroun;clear: both;display: block;float: none;height: 5px;width: 100%;"><img src="' + FCKConfig.BasePath +'css/images/fck_pagebreak.gif" /></div><br />';
	...
	FCKConfig.insertHtml_showDialog = false;
	...
	FCKConfig.insertHtml_buttonTooltip = 'Insert Article Breake';
