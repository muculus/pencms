<?php
App::import('Vendor', 'cake_method_table', array('file' => "cakeswx".DS."php".DS."core".DS."amf".DS."util".DS."CakeMethodTable.php"));
/**
 * A built-in amfphp service that allows introspection into services and their methods.
 * Remove from production servers
 */
class DiscoveryService extends AppController
{
	var $name = 'DiscoveryService';
